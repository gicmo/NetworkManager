                                ...
                                const char *error_desc)
{
	...
	nm_assert (NM_IS_ACTIVE_CONNECTION (active));
	nm_assert (nm_auth_subject_is_internal (nm_active_connection_get_subject (active)));
	 ...
	 */
	if (nm_active_connection_get_activation_reason (active) != NM_ACTIVATION_REASON_AUTOCONNECT_SLAVES) {
		c_list_for_each_entry (ac, &priv->active_connections_lst_head, active_connections_lst) {
